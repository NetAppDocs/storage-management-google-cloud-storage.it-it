...
summary: Quando il tuo sistema Google Cloud Storage è disponibile nella pagina Sistemi, puoi aggiungere altri bucket direttamente dalla NetApp Console. 
---
...
[role="lead"]
Quando il tuo sistema Google Cloud Storage è disponibile nella pagina Sistemi, puoi aggiungere altri bucket direttamente dalla NetApp Console.
